 ...
 * Analizador de documentos, Generador de presentaciones, Simulador de
 * exámenes. El resto del catálogo (incluye Flashcards, Preparador de
 * exposiciones, Chat con documentos, Resumir, Corrector APA, etc.)
 * sigue gratis.
 */
